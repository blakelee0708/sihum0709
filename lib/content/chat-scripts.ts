 ...
 *
 * PRD 14.11이 정한 값은 150초입니다.
 *
 * 실측 주의 — 섹션 확대 전(목표 4,800자) 조건에서 필기가 188.7초,
 * 면접이 121.8초 걸렸습니다. PRD 8.3, 8.4의 목표가 7,200 / 7,900자로
 * 더 올라갔으므로 150초로는 필기가 정상 완료돼도 실패로 처리될 가능성이
 * 큽니다. 값은 PRD를 따르되 [14] 실측에서 확인해야 합니다.
 *
 * Vercel 함수 상한은 300초입니다 (PRD 15.1).
 */
export const GENERATING_TIMEOUT_MS = 150_000
